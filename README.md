...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) and has been customized to create a real-time chat application.
